...
//==============================================================================
ReversedDelayAudioProcessorEditor::ReversedDelayAudioProcessorEditor (ReversedDelayAudioProcessor& p, juce::AudioProcessorValueTreeState& vts)
    : AudioProcessorEditor (&p), audioProcessor (p), valueTreeState(vts)
{
	...
	for (int i = 0; i < N_SLIDERS_COUNT; i++)
	{
		...
		//Lable
		label.setText(ReversedDelayAudioProcessor::paramsNames[i], juce::dontSendNotification);
		...
		m_sliderAttachment[i].reset(new SliderAttachment(valueTreeState, ReversedDelayAudioProcessor::paramsNames[i], slider));
	}

	setSize((int)(SLIDER_WIDTH * 0.01f * SCALE * N_SLIDERS_COUNT), (int)(SLIDER_WIDTH * 0.01f * SCALE));
}

ReversedDelayAudioProcessorEditor::~ReversedDelayAudioProcessorEditor()
{
}

//==============================================================================
void ReversedDelayAudioProcessorEditor::paint (juce::Graphics& g)
{
	g.fillAll(juce::Colour::fromHSV(HUE * 0.01f, 0.5f, 0.7f, 1.0f));
}

void ReversedDelayAudioProcessorEditor::resized()
{
	// Sliders + Menus
